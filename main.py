...
for i in range(3):
    print(random.random())
#     Generate and print numbers between zero and one (0-1)

for i in range(3):
    print(random.randint(1, 20))


#     Generate and print numbers between one and twenty (1-20)

# def pick_team_leader(arr_members):
#     random_number = random.randint(0, len(arr_members))
#     print(len(arr_members))
#     return arr_members[random_number]
#
#
# print(pick_team_leader(['John', 'Mike', 'Sarah', 'Mattew', 'Bill', 'Fati', 'Eoin']))
#
